...
var Diamond = require('../assets/people-intro.svg');
      ...
      >
        ...
        <Image
          ...
          <View style={{
            ...
            <Text
              style={[styles.titleStyle, styles.bold]}
            >
              {mainTitle}
            </Text>
            <Text
              style={[styles.subTitleStyle, styles.bold]}
            >
              {secondTitle}
            </Text>
          </View>
          <View style={{marginTop: 10}}>
            <Text style={[styles.urlStyle, styles.bold]}>
              {urlTitle}
            </Text>
          </View>
      </View>
